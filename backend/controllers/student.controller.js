...
export { registerStudent, logout, login, authMiddleware, studentProfileController, sendRequest, checkStatus, isValidForQR, changingKey, fetchWardern, personalHistory}